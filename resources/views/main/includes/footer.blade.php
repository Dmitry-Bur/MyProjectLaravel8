                    ...
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="index.html" class="footer__logo-link">
                                <img src="{{asset('main/assets/img/logo/logo-color.jpg/')}}" alt="" class="footer__logo-img">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="footer__payment">
                        <a href="https://hasthemes.com/" class="footer__payment-link">
                            <img src="{{asset('main/assets/img/company-logo/payment.png/')}}" alt="" class="footer__payment-img">
                        </a>
                    </div>
                </div>
            </div>
